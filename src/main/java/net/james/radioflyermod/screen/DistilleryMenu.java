...
public class DistilleryMenu extends AbstractContainerMenu {
    ...
    public DistilleryMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 132, 56));
            this.addSlot(new SlotItemHandler(handler, 1, 48, 18));
            this.addSlot(new SlotItemHandler(handler, 2, 99, 18));
        });
    ...
    public DistilleryBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DISTILLERY.get());
    }
