package net.james.radioflyermod.networking;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(RadioflyerMod.MOD_ID, "messages"))
        ...
        net.messageBuilder(DecomposerEnergySyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(DecomposerEnergySyncS2CPacket::new)
                .encoder(DecomposerEnergySyncS2CPacket::toBytes)
                .consumerMainThread(DecomposerEnergySyncS2CPacket::handle)
                .add();
