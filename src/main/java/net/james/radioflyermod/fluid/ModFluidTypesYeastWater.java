...
public class ModFluidTypesYeastWater {
    ...
    public static final RegistryObject<FluidType> YEAST_WATER_FLUID_TYPE = register("yeast_water_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, SOAP_OVERLAY_RL,
                0xA1C8BF97, new Vector3f(89f / 255f, 89f / 255f, 89f / 255f), properties));
    }
